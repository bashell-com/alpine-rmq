...
- `3.7.9` ([Dockerfile](https://bitbucket.org/bashell-com/alpine-rmq/src/3.7.9/Dockerfile?fileviewer=file-view-default))
- `3.7.8` ([Dockerfile](https://bitbucket.org/bashell-com/alpine-rmq/src/3.7.8/Dockerfile?fileviewer=file-view-default))
- `3.7.7` ([Dockerfile](https://bitbucket.org/bashell-com/alpine-rmq/src/3.7.7/Dockerfile?fileviewer=file-view-default))
